...
SCRIPT_TO_TEST_FILES = {
    ...
    "benchmark_route_graph_warmup.py": ["test_route_graph_warmup_benchmark.py", "test_scripts_smoke_all.py"],
    ...
    "build_route_graph_subset.py": ["test_scripts_builders_extended.py", "test_scripts_smoke_all.py"],
    ...
    "build_od_corpus_uk.py": ["test_thesis_evaluation_runner.py", "test_scripts_smoke_all.py"],
    ...
    "compare_thesis_runs.py": ["test_compare_thesis_runs.py", "test_scripts_smoke_all.py"],
    "compose_thesis_sharded_report.py": ["test_compose_thesis_sharded_report.py", "test_scripts_smoke_all.py"],
    "compose_thesis_suite_report.py": ["test_thesis_evaluation_runner.py", "test_scripts_smoke_all.py"],
    "enrich_od_corpus_with_ambiguity.py": ["test_enrich_od_corpus_with_ambiguity.py", "test_scripts_smoke_all.py"],
    "evaluation_metrics.py": ["test_thesis_evaluation_runner.py", "test_scripts_smoke_all.py"],
    "expand_thesis_broad_corpus.py": ["test_expand_thesis_broad_corpus.py", "test_scripts_smoke_all.py"],
    "export_p67_certified_set_bundle.py": ["test_route_response_refc_smoke.py", "test_scripts_smoke_all.py"],
    ...
    "generate_preference_query_worked_example_bundle.py": [
        "test_preference_query_worked_example_bundle.py",
        "test_scripts_smoke_all.py",
    ],
    ...
    "run_full_latest_suite.py": [
        "test_full_latest_suite_republish_root.py",
        "test_thesis_evaluation_runner.py",
        "test_scripts_smoke_all.py",
    ],
    "run_headless_scenario.py": ["test_tooling_scripts.py", "test_scripts_smoke_all.py"],
    "run_hot_rerun_benchmark.py": ["test_hot_rerun_benchmark.py", "test_scripts_smoke_all.py"],
    "run_thesis_campaign.py": ["test_thesis_campaign_script.py", "test_scripts_smoke_all.py"],
    "run_thesis_hard_story_suite.py": ["test_thesis_hard_story_suite_script.py", "test_scripts_smoke_all.py"],
