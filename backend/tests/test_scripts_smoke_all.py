...
EXPECTED_SCRIPT_FILES = {
    ...
    "compare_thesis_runs.py",
    "compose_thesis_sharded_report.py",
    "compose_thesis_suite_report.py",
    "enrich_od_corpus_with_ambiguity.py",
    "evaluation_metrics.py",
    "expand_thesis_broad_corpus.py",
    "export_p67_certified_set_bundle.py",
    ...
    "run_hot_rerun_benchmark.py",
    "run_thesis_campaign.py",
    "run_thesis_hard_story_suite.py",
    "run_thesis_lane.py",
    "run_thesis_evaluation.py",
